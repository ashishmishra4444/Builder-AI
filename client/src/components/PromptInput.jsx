  ...
  if (variant === "glass") {
    return (
      <form
        ...
        className="max-w-2xl w-full bg-white/10 backdrop-blur-md rounded-lg ring-1 ring-white/25 focus-within:ring-2 focus-within:ring-white/30 overflow-hidden mt-6 transition"
      >
        <textarea
          ref={textareaRef}
          value={value}

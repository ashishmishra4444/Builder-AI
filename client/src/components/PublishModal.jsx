...
const PublishModal = ({ publishUrl, onClose }) => {
  ...
  return (
    <div className="absolute inset-0 bg-zinc-950/40 backdrop-blur-xs flex items-center justify-center z-50">
      <div className="bg-white border border-zinc-200 shadow-1g rounded-xl max-w-md w-full p-6 mx-4 relative">
        <button
          onClick={onClose}
        ...
        <div className="mb-6">
          <h3 className="text-1g font-medium text-zinc-900 mb-1">
